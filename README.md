...
![A guide about choosing an open source license](screenshots/legal-guide.png)
...
![The actions menu with keyboard shortcuts](screenshots/actions.png)
...
![A guide snoozed until local midnight](screenshots/rest-mode.png)
